    ...
    if (page === "home") {
        ...
        area.innerHTML = `
            <div class="content-box glass">
                ...
                <h3>🪙 Coin Group</h3>
                <p>Select the Telegram group whose bot wallet should be shown and used by this panel.</p>
        ...
        try {
            ...
            if (!groups.length) {
                ...
                status.textContent = "Open the group and send a message so the bot can link your Telegram account to it.";
            } else {
                ...
                status.textContent = data.selected
                ...
                select.addEventListener("change", async () => {
                    ...
                    try {
                        ...
                        current = result.user;
                        updateHeader();
                        status.textContent = "✅ Group wallet connected.";
                        toast("Telegram wallet connected!");
                    } catch (error) {
                        toast(error.message);
                    }
                });
            ...
            $("coinGroupStatus").textContent = error.message;
        }
